...
function makeHelpers(env) {
  ...
  function parseBankAmount(v){if(v==null)return 0;let s=enNum(String(v)).replace(/[,٬\s]/g,'');let n=parseFloat(s);if(!isFinite(n)||n===0)return 0;/* صورت‌حساب بانک‌های ایران معمولاً ریال است و اپ هم ریال ذخیره می‌کند. */return Math.round(n)}
