/* ============================================================================
 * راستی‌آزمایی زندهٔ هِسته — اسکریپت کنسول مرورگر (۴ چک، ~۱ دقیقه)
 * ----------------------------------------------------------------------------
 ...
 * ۳ و ۴ هیچ تغییری روی داده نمی‌دهند (پیش‌نمایش، بدون apply).
 *
 * انتظار: چهار خط ✅ (و طبیعتاً اگر ورکر نسخهٔ قدیمی باشد، ❌ روی چک ۳ و ۴).
 * ==========================================================================*/
(async () => {
  'use strict';
